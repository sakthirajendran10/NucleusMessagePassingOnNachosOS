...
Timer::Timer(bool doRandom, CallBackObj *toCall, int quant)
{
    randomize = doRandom;
    ...
    cout<<"\nInside the timer";
    if(quant<1000){
      cout<<"\nEntered quantum is lesser than the limit. So, the default value of 1000 is set for quantum.";
      quantum=1000;
    }
    else{
      cout<<"\nSystem Quantum is set to "<<quant<<endl;
      quantum=quant;
    }
    SetInterrupt();
}
