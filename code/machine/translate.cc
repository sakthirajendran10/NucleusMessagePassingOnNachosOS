...
Machine::Translate(int virtAddr, int* physAddr, int size, bool writing)
{
    ...
    //cout<<"\nTranslate " << virtAddr << (writing ? " , write" : " , read")<<endl;
...
// from the virtual address
	...
	if (vpn >= pageTableSize) {
        ...
        cout<<"Exception caught while translating"<<endl;
        cout<<"Invalid virtual Addr:" << virtAddr<<endl;
        cout<<"Invalid virtual page number:"<<vpn<<endl;
	...
	if (entry == NULL) {				// not found
            ...
            cout<< "Invalid TLB entry for this virtual page!"<<endl;
